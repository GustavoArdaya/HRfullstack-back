...
VALUES
  ('Perico','Lospa Lotes', './photos/default.png', 'Currante','600123456','perico@lospa.com','Barcelona','12345678Z',1234.56,'2020-04-27','1987-07-05',2),
  ...
  ('Gustavo','Ardaya', './photos/GustavoArdaya.jpg', 'Currante','600123456','perico@lospa.com','Barcelona','12345678Z',1234.56,'2020-04-27','1987-07-05',2),
  ...
  ('Jaume','Vidal' ,'./photos/JaumeVidal.png', 'Currante','600123456','perico@lospa.com','Barcelona','12345678Z',1234.56, '2020-04-27','1989-01-01',2),
  	...
  	('Diego Armando', 'Delgado Bueno', 'https://splitleasing-danmark.dk/wp-content/uploads/2021/04/NK-200x200.png', 'Encargado 1', '674328598', 'diegodelgado@gmail.com', 'Barcelona', 'Y7753236L', 1500, '2020-9-20', '2000-11-3',2),
  	('Minodora Eustaquia', 'Lafuente Diego', 'https://www.pensioennavigator.nl/wp-content/uploads/2018/01/vrouw.png', 'Encargado 2', '699453421', 'm_lafuente12@gmail.com', 'Badalona', '67845327L', '1500', '2016-5-15', '1980-10-9',2),
  	...
  	('Diego Marcelo', 'Lopes da Cunha', 'https://sevilla.abc.es/personajes/admin/uploads/Arnold_Schwarzenegger.jpg', 'Programer Senior', '695137557', 'Diego_Marcelo@gmail.com', 'Hospitalet de Llobregat', '44895269M', '2763', '2022-2-19', '1963-4-12',2),
  	('Carolina Alana', 'Pires Cavalcanti', 'https://www.informador.mx/__export/1506064415808/sites/elinformador/img/historico/11/1028117.jpg_1970638775.jpg', 'Director Marca', '694385062', 'Carolina_Alana@gmail.com', 'Badalona', 'Z2245131Z', '1915', '2014-10-2', '1987-6-5',2),
  	('João Felipe', 'da Cunha Correia', 'https://cdn.shopify.com/s/files/1/1600/9673/files/jamesbond-sean_connery_large.png', 'Corporativo', '679269590', 'João_Felipe@gmail.com', 'Tarrasa', 'X7770128S', '2791', '2022-2-3', '1994-6-8',2),
  	...
  	('Miss Kelly Jessica', 'Grant Sandoval', 'https://cdn2.chicmagazine.com.mx/uploads/media/2020/09/01/zendaya-antes-y-despues-de.jpg', 'Jefe de Investigación', '684158014', 'Miss_Kelly_Jessica@gmail.com', 'Lérida', 'Y5625580R', '2740', '2015-4-28', '1969-6-14',2),
  	('Yago Agustín', 'Redondo Tamarit', 'https://fototrending.com/wp-content/uploads/imagenes-mas-famosas-de-la-historia.jpg', 'Marketing Producto', '658426813', 'Yago_Agustín@gmail.com', 'Tarragona', '08754661X', '2122', '2018-3-30', '1991-4-18',2),
  	...
  	('Teodosio Ernestino', 'Gomis Rebollo', 'https://academiaplay.es/wp-content/uploads/2016/10/Karl-Marx.jpg', 'Respuestas Distrito', '664970571', 'Teodosio_Ernestino@gmail.com', 'Reus', '01270038R', '2524', '2016-4-11', '1965-7-13',2),
  	...
  	('James Brandon', 'Black Berry', 'https://academiaplay.es/wp-content/uploads/2016/10/Nikola-Tesla.jpg', 'Aplicaciones', '691583489', 'James_Brandon@gmail.com', 'Cornellá de Llobregat', 'X0307995W', '2421', '2016-12-6', '1960-5-22',2),
